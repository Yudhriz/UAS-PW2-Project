         ...
         <div class="p-t-40">
             <div class="flex-c-m flex-w p-b-18">
                 <a href="#" class="m-all-1">
                     <img src="{{ asset('home/images/icons/icon-pay-01.png') }}" alt="ICON-PAY">
                 </a>

                 <a href="#" class="m-all-1">
                     <img src="{{ asset('home/images/icons/icon-pay-02.png') }}" alt="ICON-PAY">
                 </a>

                 <a href="#" class="m-all-1">
                     <img src="{{ asset('home/images/icons/icon-pay-03.png') }}" alt="ICON-PAY">
                 </a>

                 <a href="#" class="m-all-1">
                     <img src="{{ asset('home/images/icons/icon-pay-04.png') }}" alt="ICON-PAY">
                 </a>

                 <a href="#" class="m-all-1">
                     <img src="{{ asset('home/images/icons/icon-pay-05.png') }}" alt="ICON-PAY">
                 </a>
             </div>
                         ...
                         <div class="wrap-slick3 flex-sb flex-w">
                             ...
                             <div class="slick3 gallery-lb">
                                 <div class="item-slick3" data-thumb="images/product-detail-01.jpg">
                                     <div class="wrap-pic-w pos-relative">
                                         ...
                                         <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                             href="{{ asset('home/images/product-detail-01.jpg') }}">
                                 ...
                                 <div class="item-slick3" data-thumb="images/product-detail-02.jpg">
                                     <div class="wrap-pic-w pos-relative">
                                         <img src="{{ asset('home/images/product-detail-02.jpg') }}" alt="IMG-PRODUCT">

                                         <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                             href="{{ asset('home/images/product-detail-02.jpg') }}">
                                             <i class="fa fa-expand"></i>
                                         </a>
                                     </div>
                                 </div>
                                 ...
                                 <div class="item-slick3" data-thumb="images/product-detail-03.jpg">
                                     <div class="wrap-pic-w pos-relative">
                                         <img src="{{ asset('home/images/product-detail-03.jpg') }}" alt="IMG-PRODUCT">

                                         <a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04"
                                             href="{{ asset('home/images/product-detail-03.jpg') }}">
                                             <i class="fa fa-expand"></i>
                                         </a>
                                     </div>
                                 </div>
