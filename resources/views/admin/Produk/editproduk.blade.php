  ...
  <form method="POST" action="{{url('/admin/produk/update')}}" enctype="multipart/form-data">
    ...
    <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-8">
          <input id="text2" name="harga" type="text" class="form-control"value="{{$p->harga}}">
        </div>
      </div>
      <div class="form-group row">
        <label for="text3" class="col-4 col-form-label">Harga Diskon</label>
        <div class="col-8">
          <input id="text3" name="harga_diskon" type="text" class="form-control" value="{{$p->harga_diskon}}">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row mb-2">
        ...
        <div class="col-8">
          <div class="input-group">
            ...
            <input id="gambar" name="foto_produk" type="file" class="form-control" value="{{$p->foto_produk}}">
          </div>
        </div>
      </div>
      <div class="form-group row">
